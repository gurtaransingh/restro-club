    ...
    <main className="innerPage portalPage">
      ...
      <section className="sectionWrap flushTop bookingConsole">
        <div className="sectionIntro wide">
          <p className="eyebrow">Concierge request</p>
          <h2>Capture support, quote and service requests from the portal.</h2>
        </div>
        <form className="portalForm" action="/api/portal/requests" method="post">
          <label>Topic<input name="topic" defaultValue="Add Gold discount to cabana quote" /></label>
          <label>Preferred channel<select name="preferredChannel" defaultValue="WhatsApp"><option>WhatsApp</option><option>Email</option><option>SMS</option><option>Phone call</option></select></label>
          <label className="wideField">Details<textarea name="details" defaultValue="Please confirm whether my Gold membership discount can be applied before I approve the pool cabana package." /></label>
          <button type="submit">Send concierge request</button>
        </form>
      </section>
