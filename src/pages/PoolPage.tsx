...
import { Waves, Calendar, Clock, Sun, Sparkles, CheckCircle2, ShieldCheck } from 'lucide-react';
...
export const PoolPage: React.FC = () => {
  ...
  const poolExperiences = [
    {
      title: 'Temperature-Controlled Olympic Pool',
      desc: '25-meter half-Olympic heated swimming pool featuring dedicated lap lanes and underwater ambient lighting.',
    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white pb-24">
      ...
      {isBookingOpen && (
        <BookingModal
          facility={{
            id: 'fac-pool',
            name: 'Poolside Cabana & Pass',
            category: 'Swimming Pool',
            locationId: activeLocation.id,
            courtDetails: 'Main Pooldeck',
            ...
            peakPrice: 1200,
            status: 'AVAILABLE',
            rules: 'Proper swimwear mandatory. No glass containers poolside.',
            image: 'https://images.unsplash.com/photo-1576013551627-0cc20b96c2a7?auto=format&fit=crop&w=800&q=80',
          }}
