...
import { AccommodationRoomMaster } from '../types';
import { BookingModal } from '../components/BookingModal';
import { BedDouble, Users, Sparkles, Check, ChevronRight, MapPin } from 'lucide-react';

export const StaysPage: React.FC = () => {
  const { rooms, activeLocation } = useApp();
  const [selectedRoom, setSelectedRoom] = useState<AccommodationRoomMaster | null>(null);
